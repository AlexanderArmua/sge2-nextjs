...
import ActionButtons from "./_components/action-buttons"; // O un ActionButtons específico para divisiones
...
export default async function Page({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      <ActionButtons filters={filters} /> {/* Si tienes botones de acción */}
